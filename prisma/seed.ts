  ...
  const checklistTemplates = [
    {
      ...
      data: [
        { title: 'Set overall wedding budget', category: 'LEGAL', phase: 'BUDGETING', priority: 1 },
        { title: 'Decide on wedding size (intimate / medium / large)', category: 'OTHER', phase: 'BUDGETING', priority: 1 },
        { title: 'Allocate budget by category', category: 'OTHER', phase: 'BUDGETING', priority: 1 },
        { title: 'Open a dedicated wedding savings account', category: 'LEGAL', phase: 'BUDGETING', priority: 2 },
        { title: 'Choose wedding date', category: 'OTHER', phase: 'PLANNING', priority: 1 },
        { title: 'Book main venue', category: 'VENUE', phase: 'PLANNING', priority: 1 },
        { title: 'Create guest list (first draft)', category: 'OTHER', phase: 'PLANNING', priority: 1 },
        { title: 'Book officiant / pastor / kadhi', category: 'LEGAL', phase: 'PLANNING', priority: 1 },
        { title: 'Book photographer', category: 'PHOTOGRAPHY', phase: 'PLANNING', priority: 1 },
        { title: 'Book videographer', category: 'PHOTOGRAPHY', phase: 'PLANNING', priority: 2 },
        { title: 'Book caterer', category: 'CATERING', phase: 'PLANNING', priority: 1 },
        { title: 'Book DJ / band', category: 'MUSIC', phase: 'PLANNING', priority: 2 },
        { title: 'Send save-the-dates', category: 'INVITATIONS', phase: 'PLANNING', priority: 2 },
        { title: 'Order wedding dress / attire', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Book hair & makeup artist', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Book florist', category: 'DECORATIONS', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Book transport (bridal car, guest buses)', category: 'TRANSPORT', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Send formal invitations', category: 'INVITATIONS', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Arrange accommodation for out-of-town guests', category: 'ACCOMMODATION', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Plan honeymoon', category: 'HONEYMOON', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Confirm all vendor bookings', category: 'OTHER', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Final dress fitting', category: 'ATTIRE', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Confirm guest RSVPs and final headcount', category: 'OTHER', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Confirm catering final menu and headcount', category: 'CATERING', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Prepare seating plan', category: 'OTHER', phase: 'PROCUREMENT', priority: 2 },
        { title: 'Prepare wedding day timeline', category: 'OTHER', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Collect marriage certificate requirements', category: 'LEGAL', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Bride preparation', category: 'ATTIRE', phase: 'DAY_OF', priority: 1 },
        { title: 'Groom preparation', category: 'ATTIRE', phase: 'DAY_OF', priority: 1 },
        { title: 'Venue setup check', category: 'VENUE', phase: 'DAY_OF', priority: 1 },
        { title: 'Confirm all vendors have arrived', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
        { title: 'Ceremony complete', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
        { title: 'Send thank-you notes to guests', category: 'OTHER', phase: 'POST_WEDDING', priority: 1 },
        { title: 'Return rented items', category: 'OTHER', phase: 'POST_WEDDING', priority: 2 },
        { title: 'Register marriage certificate', category: 'LEGAL', phase: 'POST_WEDDING', priority: 1 },
        { title: 'Review and pay final vendor invoices', category: 'OTHER', phase: 'POST_WEDDING', priority: 1 },
      ],
    },
    {
      ...
      culturalType: 'KIKUYU',
      data: [
        { title: 'Agree on Ruracio date with both families', category: 'LEGAL', phase: 'PLANNING', priority: 1 },
        { title: 'Prepare dowry list (bride price items)', category: 'OTHER', phase: 'PLANNING', priority: 1 },
        { title: 'Book venue for Ruracio', category: 'VENUE', phase: 'PLANNING', priority: 1 },
        { title: 'Arrange catering for Ruracio guests', category: 'CATERING', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Prepare traditional attire (Kikuyu)', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Confirm elders / spokespersons for negotiation', category: 'OTHER', phase: 'PRE_WEDDING', priority: 1 },
        { title: "Prepare gifts for bride's family", category: 'OTHER', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Ruracio ceremony complete', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
        { title: 'Dowry items delivered and acknowledged', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
      ],
    },
    {
      name: 'Wedding Day Checklist',
      data: [
        { title: 'Wake up and have breakfast', category: 'OTHER', phase: 'DAY_OF', priority: 1 },
        { title: 'Hair & makeup — bride', category: 'ATTIRE', phase: 'DAY_OF', priority: 1 },
        { title: 'Groom and groomsmen dressed', category: 'ATTIRE', phase: 'DAY_OF', priority: 1 },
        { title: 'Bouquets and buttonholes collected', category: 'DECORATIONS', phase: 'DAY_OF', priority: 1 },
        { title: 'Venue decorated and ready', category: 'VENUE', phase: 'DAY_OF', priority: 1 },
        { title: 'Photographer briefed', category: 'PHOTOGRAPHY', phase: 'DAY_OF', priority: 1 },
        { title: 'Caterer confirmed on-site', category: 'CATERING', phase: 'DAY_OF', priority: 1 },
        { title: 'DJ / band set up and sound-checked', category: 'MUSIC', phase: 'DAY_OF', priority: 1 },
        { title: 'Transport confirmed and on schedule', category: 'TRANSPORT', phase: 'DAY_OF', priority: 1 },
        { title: 'All vendors confirmed on-site', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
        { title: 'Ceremony complete', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
        { title: 'Rings exchanged', category: 'OTHER', phase: 'DAY_OF', priority: 1, isFinalCheck: true },
      ],
    },
    {
      name: 'Bride Preparation Checklist',
      data: [
        { title: 'Book hair & makeup trial', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'First dress fitting', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 1 },
        { title: 'Second dress fitting', category: 'ATTIRE', phase: 'PROCUREMENT', priority: 1 },
        { title: 'Final dress fitting', category: 'ATTIRE', phase: 'PROCUREMENT', priority: 1, isFinalCheck: true },
        { title: 'Choose bridesmaids attire', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Buy wedding shoes', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Buy wedding jewellery', category: 'ATTIRE', phase: 'PRE_WEDDING', priority: 2 },
        { title: 'Bridal shower', category: 'OTHER', phase: 'PRE_WEDDING', priority: 3 },
        { title: 'Confirm hair & makeup for wedding day', category: 'ATTIRE', phase: 'PROCUREMENT', priority: 1 },
      ],
    },
  ]
